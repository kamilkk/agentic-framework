...
- **Name**: improve-codebase-architecture
- **Always Active**: No
- **Trigger**: Scan a codebase for deepening opportunities, present them as a visual HTML report, then grill through whichever one you pick.
- **Source**: Adapted from [mattpocock/skills](https://github.com/mattpocock/skills) (MIT) — `skills/engineering/improve-codebase-architecture`

## Purpose

Survey a codebase for deepening opportunities, present them as a visual HTML report, then grill through whichever one is chosen.
...
See the "HTML-REPORT" appendix below for the full HTML scaffold, diagram patterns, and styling guidance.
...
## Appendix: HTML Report Format

*Inlined from the original skill's companion file `HTML-REPORT.md`.*
