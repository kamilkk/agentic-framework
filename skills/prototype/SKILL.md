...
- **Name**: prototype
- **Always Active**: No
- **Trigger**: Build a throwaway prototype to answer a design question. Use when the user wants to sanity-check whether a state model or logic feels right, or explore what a UI should look like.
- **Source**: Adapted from [mattpocock/skills](https://github.com/mattpocock/skills) (MIT) — `skills/engineering/prototype`

## Purpose

Build throwaway code that answers a design question — a logic/state-model check, or a UI exploration.
...
- **"Does this logic / state model feel right?"** → the "LOGIC" appendix below. Build a single shareable HTML file (free-play buttons plus tabbed guided walkthroughs) that pushes the state machine through cases that are hard to reason about on paper, and that a non-developer can drive.
- **"What should this look like?"** → the "UI" appendix below. Generate several radically different UI variations on a single route, switchable via a URL search param and a floating bottom bar.
...
## Appendix: Logic / State-Model Prototypes

*Inlined from the original skill's companion file `LOGIC.md`.*
...
If the question is "what should this look like," this is the wrong branch. Use the "UI" appendix below.
...
## Appendix: UI Prototypes

*Inlined from the original skill's companion file `UI.md`.*

Generate **several radically different UI variations** on a single route, switchable from a floating bottom bar. The user flips between variants in the browser, picks one (or steals bits from each), then throws the rest away.

If the question is about logic/state rather than what something looks like, this is the wrong branch. Use the "LOGIC" appendix below.
